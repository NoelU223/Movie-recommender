...
S pokretanjem dockera pokreće se i batch processing koji se obrađuje jednom, zatim se pokreće MinIO na http://localhost:9001 gdje se mogu skinuti prikupljeni podatci (csv datoteka) i reccomendations (json)
